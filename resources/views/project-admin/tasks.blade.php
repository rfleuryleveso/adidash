...
@section('content')
    <div class="columns">
                        ...
                        <tbody>
                            @foreach ($tasks as $task)
                                <tr>
                                    ...
                                    <td><a href="{{route('project-admin.task', ['project' => $project->id, 'task' => $task->id])}}"><i class="far fa-eye"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        <div class="column is-one-third">
            ...
            <a class="button is-small is-link mt-3 is-block"
                href="{{ route('project-admin.create-task', ['project' => $project->id]) }}"><i
                    class="fas fa-plus mr-2"></i> Créer une nouvelle tâche</a>
